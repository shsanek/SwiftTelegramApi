...
extension TelegramAPI {
    ...
    public func sendAudio(_ input: SendAudioInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60, completionHandler: @escaping (TelegramResult<Message>) -> Void) {
        self.requester.request("sendAudio", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval, completion: completionHandler)
    }

    @available(macOS 10.15, iOS 13.0, watchOS 6.0, tvOS 13.0, *)
    public func sendAudio(_ input: SendAudioInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60) async throws -> Message {
        try await self.requester.request("sendAudio", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval)
    }
}
...
public final class SendAudioInput: IMultiPartFromDataEncodable {
	...
	func encode(_ encoder: MultiPartFromDataEncoder) throws {
		...
		try encoder.append("audio", object: self.audio)
		...
		try encoder.append("performer", object: self.performer)
