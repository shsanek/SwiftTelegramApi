...
extension TelegramAPI {
    ...
    @discardableResult
    public func setStickerMaskPosition(_ input: SetStickerMaskPositionInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60) async throws -> Bool {
        try await self.requester.request("setStickerMaskPosition", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval)
    }
}
