...
extension TelegramAPI {
    ...
    public func unpinAllForumTopicMessages(_ input: UnpinAllForumTopicMessagesInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60) async throws -> Bool {
        try await self.requester.request("unpinAllForumTopicMessages", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval)
    }
}
