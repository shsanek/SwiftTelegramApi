...
extension TelegramAPI {
    ...
    @discardableResult
    public func setChatAdministratorCustomTitle(_ input: SetChatAdministratorCustomTitleInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60) async throws -> Bool {
        try await self.requester.request("setChatAdministratorCustomTitle", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval)
    }
}
