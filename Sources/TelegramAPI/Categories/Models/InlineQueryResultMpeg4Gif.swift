public final class InlineQueryResultMpeg4Gif: Codable, IMultiPartFromDataEncodable {
	...
	func encode(_ encoder: MultiPartFromDataEncoder) {
		...
		encoder.append("mpeg4_url", object: self.mpeg4Url)
		encoder.append("mpeg4_width", object: self.mpeg4Width)
		encoder.append("mpeg4_height", object: self.mpeg4Height)
		encoder.append("mpeg4_duration", object: self.mpeg4Duration)
		encoder.append("thumbnail_url", object: self.thumbnailUrl)
		encoder.append("thumbnail_mime_type", object: self.thumbnailMimeType)
