...
extension TelegramAPI {
    ...
    public func stopMessageLiveLocation(_ input: StopMessageLiveLocationInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60, completionHandler: @escaping (TelegramResult<Message>) -> Void) {
