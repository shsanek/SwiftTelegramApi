...
extension TelegramAPI {
    ...
    public func editMessageMedia(_ input: EditMessageMediaInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60, completionHandler: @escaping (TelegramResult<Message>) -> Void) {
