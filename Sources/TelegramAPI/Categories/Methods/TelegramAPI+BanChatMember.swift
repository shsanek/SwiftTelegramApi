...
extension TelegramAPI {
    ...
    public func banChatMember(_ input: BanChatMemberInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60, completionHandler: @escaping (TelegramResult<Bool>) -> Void) {
