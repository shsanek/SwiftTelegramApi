...
extension TelegramAPI {
    ...
    public func setCustomEmojiStickerSetThumbnail(_ input: SetCustomEmojiStickerSetThumbnailInput, numberOfAttempts: Int = 1, timeoutInterval: TimeInterval = 60) async throws -> Bool {
        try await self.requester.request("setCustomEmojiStickerSetThumbnail", object: input, numberOfAttempts: numberOfAttempts, timeoutInterval: timeoutInterval)
    }
}
